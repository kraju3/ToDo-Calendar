...
const Tasks = [
  {"taskName":"ICD-9-CM","location":"Huanglin","time":"1:16 AM","description":"object-oriented","date":"1/6/2020"},
        ...
        <React.Fragment>
            ...
            <div className="ui segment">
              <Switch>
                ...
                <Route exact path="/calendar" render={(props)=>{return <TaskCalendar {...props}  tasks={state.tasks}/>}}></Route>
              </Switch>
            </div>
